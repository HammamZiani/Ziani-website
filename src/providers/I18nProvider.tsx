...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "Booking.concierge": "Concierge Service",
  ...
  fr: {
    ...
    "Booking.confirm": "Confirmer via WhatsApp",
    "Booking.concierge": "Service Conciergerie",
