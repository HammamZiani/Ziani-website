  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.from(".about-title", {
        scrollTrigger: {
          trigger: ".about-title",
          start: "top 85%", // Triggers when title top hits 85% of viewport height
      ...
      // 3. Animate Cards via clipPath (Shutter Effect)
      ...
      cards.forEach((card, i) => {
        ...
        gsap.set(imageWrap, { clipPath: "inset(100% 0 0 0)" }); // Hidden at bottom
        gsap.set(imageInner, { scale: 1.2 }); // Slightly zoomed
        ...
        .from(contentItems, {
          ...
          stagger: 0.1,
          ease: "power3.out",
        }, "-=1.0"); // Text reveal starts while image is still scaling
      });

    }, sectionRef);

    return () => ctx.revert(); // Standard clean-up
  }, [locale]); // Refresh triggers on language change
  ...
  return (
    <article className="bath-card group flex h-full flex-col">
      ...
      <div className="card-image-wrap relative mb-6 aspect-[3/4] max-h-[550px] overflow-hidden bg-gray-100 shadow-sm">
        ...
        {/* This stays visible because of z-index */}
      ...
      <div className="flex flex-grow flex-col">
        ...
        {/* Line remains animated by CSS hover */}
